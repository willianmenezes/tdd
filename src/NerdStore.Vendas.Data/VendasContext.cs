...
namespace NerdStore.Vendas.Data
{
    public class VendasContext : DbContext, IUnitOfWork
    {
        ...
        public VendasContext(DbContextOptions<DbContext> options, IMediator mediator) : base(options)
        {
            _mediator = mediator;
        }
    ...
    public static class MediatorExtension
    {
        public static async Task PublicarEventos(this IMediator mediator, VendasContext context)
        {
            ...
            domainEntities.ToList().ForEach(enitty => enitty.Entity.LimpasEventos());
